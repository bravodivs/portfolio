...
<div className="status">{status==='sending'?'Sending...': status==='sent'?'Sent ✅': status==='error'?'Error':' '}</div>
</div>
</form>


<footer className="footer">
<div>Let’s build something together — <a href="mailto:you@example.com">you@example.com</a></div>
